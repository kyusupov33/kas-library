...
describe('[TEST]: ApplicationType -> OSOE', () => {

  beforeEach(() => Helpers.application.type = new ApplicationType(APPLICATION_TYPE.OSOE));
  ...
  it('Should be correct processStage equals DRAFT or null when open initiator(rb300099)', () => {
    ...
    const builder = new ApplicationGrantOsoe(options);
